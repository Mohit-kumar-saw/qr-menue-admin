  ...
  return (
    <div className="space-y-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <StatCard title="Total Dishes" value={menuItems.length} icon={<UtensilsCrossed />} color="text-[#021d4f]" />
        <StatCard title="Categories" value={categories.length} icon={<Layers />} color="text-amber-500" />
        <StatCard title="Menu Scans" value="12" icon={<TrendingUp />} color="text-[#021d4f]" />
        ...
        <Card className="sm:col-span-2 p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link
              href="/menu"
              className="group flex flex-col items-center justify-center p-6 bg-blue-50/30 rounded-3xl border border-blue-100/50 hover:bg-[#021d4f] transition-all duration-500 hover:scale-[1.02] active:scale-95"
            >
              <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center mb-4 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500">
                <Plus className="text-[#021d4f]" size={24} />
              </div>
              <span className="font-serif font-semibold text-lg text-zinc-900 group-hover:text-white transition-colors">Add New Dish</span>
              <p className="text-zinc-400 group-hover:text-blue-200 text-[10px] mt-1 uppercase tracking-widest font-bold transition-colors">Menu Catalog</p>
            </Link>
            ...
            >
              <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center mb-4 group-hover:-rotate-12 group-hover:scale-110 transition-all duration-500">
                <QrCode className="text-[#021d4f]" size={24} />
              </div>
              ...
              <p className="text-zinc-400 group-hover:text-blue-200 text-[10px] mt-1 uppercase tracking-widest font-bold transition-colors">Table Setup</p>
            </Link>
          </div>
        </Card>
      </div>
  ...
  return (
    <Card className="p-6">
      <div className="flex justify-between items-start mb-4">
        <div className={cn("p-3 rounded-xl bg-blue-50 group-hover:bg-blue-100 transition-colors duration-500 shadow-inner", color)}>
          {React.cloneElement(icon as any, { size: 20 })}
        </div>
        <div className="flex flex-col items-end">
          <span className="text-[#021d4f] text-[10px] font-black bg-blue-50 px-2 py-1 rounded-lg tracking-tighter shadow-sm">+12%</span>
