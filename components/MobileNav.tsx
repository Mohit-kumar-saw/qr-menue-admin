...
export function MobileNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-6 left-6 right-6 h-16 bg-zinc-900 rounded-2xl shadow-2xl z-50 flex items-center justify-around px-4 border border-zinc-800">
